...
class AvicennaTextFieldWithPrefix extends StatelessWidget {
  const AvicennaTextFieldWithPrefix({
    Key? key,
    this.title,
    this.initialValue,
    this.onChanged,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              // const Spacer(),
              SizedBox(
                width: MediaQuery.of(context).size.width - 84 - minusWidth,
                child:
                TextFormField(
                  controller: controller,
                  onTap: onFieldTap,
                  ...
                  style: TextStyle(color: enabled ? AvicennaColors.black : AvicennaColors.black),
                  decoration: decoration ?? InputDecoration(
                    contentPadding: EdgeInsets.only(left: 0, right: 16, bottom: 0, top: textFieldStyle == AvicennaTextFieldStyle.filled ? -4 : -7.6),
                    border: InputBorder.none,
                    errorStyle: const TextStyle(
                        shadows: [
                          Shadow(color: AvicennaColors.danger, offset: Offset(-6, 18))
