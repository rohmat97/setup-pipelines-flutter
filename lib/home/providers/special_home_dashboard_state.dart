...
import 'package:kai_wisata/home/pages/special_booking_detail_page.dart';
...
class SpecialHomeDashboardState with ChangeNotifier {
  ...
  void fetchHistories() async {
    if(!isLoaded) {
      histories = await BookingServices.getSpecialTransactionHistories();
  ...
  detailClick(Transaction p) {
    Navigator.pushNamed(
        context!,
        SpecialBookingDetailPage.routeName,
