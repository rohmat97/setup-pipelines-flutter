...
import 'package:kai_wisata/home/providers/special_home_dashboard_state.dart';
...
import '../widgets/special_booking_card.dart';

class SpecialHomeBookingPage extends StatefulWidget {
  static const routeName = '/special-home-booking-page';
  ...
  @override
  _SpecialHomeBookingPageState createState() => _SpecialHomeBookingPageState();
}

class _SpecialHomeBookingPageState extends State<SpecialHomeBookingPage> {
  final GlobalKey<RefreshIndicatorState> _refreshIndicatorKey =
      GlobalKey<RefreshIndicatorState>();
  SpecialHomeDashboardState state = SpecialHomeDashboardState();
  ...
  Widget build(BuildContext context) {
    state = Provider.of<SpecialHomeDashboardState>(context);
      ...
      ...(state.filtered.map((p) =>
          Padding(
            ...
            GestureDetector(
              ...
              child : SpecialBookingCard(payment: p)
            ),
          )))
    ];
  }
