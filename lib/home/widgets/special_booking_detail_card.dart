...
import '../../kai_istimewa/models/special_booking.dart';

class SpecialBookingDetailCard extends StatelessWidget {
  const SpecialBookingDetailCard({
    Key? key,
    this.content,
    this.onTap,
  }) : super(key: key);

  final SpecialBookingInfo? content;
                    ...
                    Column(
                      ...
                      children: [
                        Column(
                          children: [
                            Text(
                              DateFormat("HH:mm").format(content!.departure),
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  DateFormat("dd MMM").format(content!.departure),
                                  style: KaiTextStyle.titleSmallBold.apply(
                                    fontSizeDelta: -2,
                                  ),
                                ),
