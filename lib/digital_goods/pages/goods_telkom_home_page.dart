...
class GoodsTelkomHomePage extends StatefulWidget {
  static const routeName = '/goods-dashboard-pages';

  const GoodsTelkomHomePage({Key? key}) : super(key: key);

  @override
  State<GoodsTelkomHomePage> createState() => _GoodsTelkomHomePageState();
}

class _GoodsTelkomHomePageState extends State<GoodsTelkomHomePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: MyColors.white,
      appBar: AppBar(
        title: const Text('Telkom',style: TextStyle(
            color: Colors.black
        )),
