...
class GoodsPdamCheckoutPage extends StatefulWidget {
  static const routeName = '/goods-dashboard-pages';

  const GoodsPdamCheckoutPage({Key? key}) : super(key: key);

  @override
  State<GoodsPdamCheckoutPage> createState() => _GoodsPdamCheckoutPageState();
}

class _GoodsPdamCheckoutPageState extends State<GoodsPdamCheckoutPage> {
  @override
