...
class GoodsBpjsCheckoutPage extends StatefulWidget {
  static const routeName = '/goods-dashboard-pages';

  const GoodsBpjsCheckoutPage({Key? key}) : super(key: key);

  @override
  State<GoodsBpjsCheckoutPage> createState() => _GoodsBpjsCheckoutPageState();
}

class _GoodsBpjsCheckoutPageState extends State<GoodsBpjsCheckoutPage> {
  @override
