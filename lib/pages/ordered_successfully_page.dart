...
class OrderedSuccessfullyPage extends StatefulWidget {
  static const routeName = '/ordered-successfully-pages';

  const OrderedSuccessfullyPage({Key? key}) : super(key: key);

  @override
  State<OrderedSuccessfullyPage> createState() =>
      _OrderedSuccessfullyPageState();
}

class _OrderedSuccessfullyPageState extends State<OrderedSuccessfullyPage> {
