...
class FlightJourneyDepartureModel {
  String? idReference;
  String? flightNumber;
  String? flightType;
  String? flightClass;
  ...
  FlightJourneyDepartureModel.fromJson(Map<String, dynamic> json) {
    idReference = json['id'];
...
class UninitializedFlightJourneyDepartureModel extends FlightJourneyDepartureModel {}